...
You would need to call it 500 times because a friendship involves two users, which means you need to multiply the number of users by the average amount of friends then divide by 2 to cut it in half.
